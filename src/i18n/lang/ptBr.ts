...
export const ptBr: LanguageFile = {
  ...
  translations: {
    ...
    'tools.gameSessions.subtitleBackup': 'Editor visual para backup.json',
    ...
    'actions.invalidFile': 'Formato inválido. Envie um arquivo games.dat, sessions.dat ou backup.json.',
